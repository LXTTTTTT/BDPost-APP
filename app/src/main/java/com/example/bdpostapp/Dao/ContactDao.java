package com.example.bdpostapp.Dao;
...
import com.example.bdpostapp.Entity.DataBase.Contact;
...
public class ContactDao extends AbstractDao<Contact, Long> {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CONTACT\" (" + //
                ...
                "\"NAME\" TEXT," + // 1: name
                "\"PHONE\" TEXT," + // 2: phone
                "\"CARD_NUMBER\" TEXT);"); // 3: card_number
    }
    ...
    public Contact readEntity(Cursor cursor, int offset) {
        Contact entity = new Contact( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3) // card_number
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Contact entity, int offset) {
        ...
        entity.setCard_number(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
     }
