...
public class WarnDialog extends DialogFragment {
    ...
    public void setData(Activity context, String str, View.OnClickListener onYesClickListener, View.OnClickListener onNoClickListener) {
...
//        Log.e(TAG, "onCreateView: " );
        ...
        noBtn.setOnClickListener(onNoClickListener);

//        // 确定按钮
//        Button yesBtn = viewContent.findViewById(R.id.yes);
//        yesBtn.setOnClickListener(onYesClickListener);
//        // 取消按键
//        Button noBtn = viewContent.findViewById(R.id.no);
//        noBtn.setOnClickListener(onNoClickListener);
